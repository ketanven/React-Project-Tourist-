...
return (
  ...
  <div className="container-xxl py-5">
    <div className="container">
      ...
      <div className="col-lg-12 gap-5 d-flex wow fadeInUp" data-wow-delay="0.1s" >
...

            {
              ...
              data-wow-delay="0.3s"
            >
              <div className="service-item team-item">
                <div className="overflow-hidden">
                  <img style={{minHeight: 200,width:300}} className="img-fluid" src={value.images} alt />
                </div>
          ...
          <div className="row g-4 justify-content-center">
            ...
            >
              <div className="package-item">
                <div className="overflow-hidden">
                  <img style={{height: 200,width:400}} className="img-fluid" src={value.img_url} alt />
                </div>
                <div className="d-flex border-bottom">
                  ...
                  <small className="flex-fill text-center border-end py-2">
                    <i className="fa fa-calendar-alt text-primary me-2" />{value.days}
                  </small>
                  <small className="flex-fill text-center py-2">
                    <i className="fa fa-user text-primary me-2" />{value.person}
                  </small>
                </div>
                <div className="text-center p-4">
      ...
      <div className="row g-4">
            ...
            >
              <div className="team-item">
                <div className="overflow-hidden">
                  <img style={{height: 200}}  className="img-fluid" src={value.images} alt />
                </div>
                <div
  ...
  <div className="container-xxl py-5 wow fadeInUp" data-wow-delay="0.1s">
    <div className="container">
      ...
      <ReactOwlCarousel className="owl-carousel owl-theme loop margin={10} nav testimonial-carousel position-relative">
            
            {
              data && data.map((value,index)=>{
                return(
                  <div className="owl-stage-outer bg-white text-center border p-4">
                  <img
